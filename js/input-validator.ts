 ...
 * 验证歌单ID
 */
export function validatePlaylistId(playlistId: string): {
  valid: boolean;
  value: string;
  error?: string;
} {
 ...
 * 验证歌手名称
 */
export function validateArtistName(artistName: string): {
  valid: boolean;
  value: string;
  error?: string;
} {
...
export function validateTextInput(
  text: string,
  maxLength: number = INPUT_LIMITS.GENERIC_TEXT_MAX
